...
| `/architecture` | **Internals Guide** — explains the gstack architecture: daemon model, ref system, logging, security, SKILL.md templates, and E2E test infrastructure. Use when contributing to or debugging gstack. |
